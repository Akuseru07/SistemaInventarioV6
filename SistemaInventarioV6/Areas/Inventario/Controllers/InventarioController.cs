...
namespace SistemaInventarioV6.Areas.Inventario.Controllers
{
    ...
    public class InventarioController : Controller
    {
        ...
        [BindProperty] //por que la vamos a usar todo el tiempo en la vista y asi y siempre va a haber un cambio de valor
        ...
        public IActionResult NuevoInventario()
        {
            ...
            var claim = claimIdentity.FindFirst(ClaimTypes.NameIdentifier);//Capturamos el usuario que esta logeado en ese momento
        ...
        public async Task<IActionResult> DetalleInventario(int InventarioId, int productoId, int cantidadId)
        {
            ...
            var bodegaProducto = await _unidadTrabajo.BodegaProducto.ObtenerPrimero(b => b.Id == productoId && 
        ...
        public async Task<IActionResult> GenerarStock(int id)
        {
            ...
            foreach (var item in detalleLista)
            {
                ...
                if(bodegaProducto != null) //si el registro de stock existe se actualizan las cantidades
                {
